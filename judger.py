...
class Judger:
    ...
    def __init__(self, accusation_path, law_path):
        ...
        f = open(accusation_path, "r",encoding='utf8')
        self.task1_cnt = 0
        for line in f:
            self.task1_cnt += 1
    ...
    def test(self, truth_path, output_path):
        ...
        for file_name in os.listdir(truth_path):
            inf = open(os.path.join(truth_path, file_name), "r",encoding='utf8')
            ouf = open(os.path.join(output_path, file_name), "r",encoding='utf8')
...
judge = Judger('D:/lawCompetition/good/accu.txt',
               'D:/lawCompetition/good/law.txt')
result=judge.test('D:/lawCompetition/input_path',
           'D:/lawCompetition/output_path')
result=judge.get_score(result)
print(result)
